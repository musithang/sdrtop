...
//! saved frequency, and toggle the log overlay. Picking one gain stage with
//! `,` / `.` used to live here; it is a key every section has now
//! (`global::gain`), because a radio's stages are not the Rail's alone.
