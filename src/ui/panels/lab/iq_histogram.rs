...
impl Panel for IqHistogramPanel {
    ...
    fn render(
        ...
        let mid_cols = (chart_area.width as usize)
            .saturating_sub(low_cols + high_cols)
            .max(1);
        ...
        f.render_widget(
            Paragraph::new(Span::styled(
                ...
                format!(
                    "{:>width$}",
                    mid_label,
                    width = pad + mid_label.chars().count()
                ),
        ...
        let label = if total == 0 {
            ...
            Span::styled(
                "▼ weak signal — ADC under-utilised",
