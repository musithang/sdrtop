...
pub(super) fn rail_peaks(bins: &[f32], noise_floor: f32, center_hz: u64, sample_rate: f64, n: usize)
    -> Vec<(u64, f32)> {
...
pub(super) fn mode_card_lines(mode: RailMode, state: &SdrMetrics, stale: bool,
